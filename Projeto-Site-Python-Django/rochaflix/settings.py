"""
Django settings for rochaflix project.
...
SECRET_KEY = 'django-insecure-r@vpc&$waabnm9rl=ex%n^mz7^em_kc7pd-u_*vg)_-2_%buz@'
...
WSGI_APPLICATION = 'rochaflix.wsgi.application'
